...
@section('content')
    ...
    <h1>Supplier Sale Report <a href="{{ url('/reports') }}" class="btn btn-primary pull-right btn-sm">Back</a></h1>
    <hr/>
{!! Form::open(['url' => 'reports/sales_report_supplier','method'=>'get', 'class' => 'form-inline']) !!}
    ...
    <div class="form-group">
    <label for="endingdate">Supplier </label>
                        
                        
                            {!! Form::select('supplier_id', $suppliers, isset($_GET['supplier_id'])?$_GET['supplier_id']:null, ['class' => 'form-control']) !!}
